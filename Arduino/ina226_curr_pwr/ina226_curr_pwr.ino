...
void setup() {
  ...
  */
  ina226.setCurrentRange(MA_400); // choose gain and uncomment for change of default
  ...
  */
  ...
  ina226.setResistorRange(0.1, 0.03); // choose resistor 0.1 Ohm and gain range up to 1.3A
